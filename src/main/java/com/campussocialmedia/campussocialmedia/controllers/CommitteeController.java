...
public class CommitteeController {
    ...
    public ResponseEntity<?> getCommitteeAbout(@RequestHeader(name = "Authorization") String token)
    ...
    @GetMapping("/committee/about/{userName}")
    public ResponseEntity<?> getCommitteeAboutOther(@PathVariable String userName) throws SignatureException {
    ...
    public ResponseEntity<?> getCommitteeFollowers(@RequestHeader(name = "Authorization") String token)
            throws SignatureException {
    ...
    @GetMapping("/committee/getFollowers/{userName}")
    public ResponseEntity<?> getCommitteeFollowersOther(@PathVariable String userName) throws SignatureException {
    ...
    public ResponseEntity<?> addFollower(@RequestBody Map<String, String> map,
            @RequestHeader(name = "Authorization") String token) throws SignatureException {

        String followerUserName = map.get("followerUserName");
        ...
        try {
            committeeService.addFollower(followerUserName, userName);
    ...
    public ResponseEntity<?> removeFollower(@RequestBody Map<String, String> map,
            @RequestHeader(name = "Authorization") String token) throws SignatureException {
        ...
        try {
            if (committeeService.removeFollower(followerUserName, userName)) {
                return new ResponseEntity<>(HttpStatus.OK);
            } else {
            ...
            ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Error removing follower",
                    "Some Details");
    ...
    public ResponseEntity<?> getCommitteeMembers(@RequestHeader(name = "Authorization") String token)
            throws SignatureException {
        String jwt = token.substring(7);
        String userName = jwtUtil.extractUsername(jwt);
    ...
    @PostMapping("/committee/addMember")
    public ResponseEntity<?> addCommitteeMember(@RequestBody CommitteeMembers committeeMemberObject,
        ...
        try {
            ...
            ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Error in adding committee member",
                    "some details");
    ...
    public ResponseEntity<?> deleteMember(@RequestBody CommitteeMembers committeeMemberObject,
        ...
        try {
            ...
            ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(),
                    "Error in removing committee member", "Some Details");
    ...
    @GetMapping("/committee/getProfilePhoto/{userName}")
	public String getProfilePhotoForCommittee(@PathVariable String userName) {
