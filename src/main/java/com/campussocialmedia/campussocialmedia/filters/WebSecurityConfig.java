...
class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.cors().and().csrf().disable().authorizeRequests()
				.antMatchers("/login", "/signUp", "/addDomainName", "/college/{emailId}", "/confirm-account" , "/committee/signUp", "/committee/login", "/committee/confirm-account", "/forgotPassword", "/reset-password").permitAll().anyRequest()
